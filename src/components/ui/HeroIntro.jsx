    ...
    <div className="relative h-screen w-full flex items-center justify-center bg-black overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center gap-16 px-6 max-w-7xl">
        ...
        >
          ...
          <img
            src="public\pexels-moh-adbelghaffar-771742.jpg" 
            alt="Gonzalo Varela"
            className="relative w-64 h-64 md:w-80 md:h-80 rounded-full object-cover border border-white/10 grayscale hover:grayscale-0 transition-all duration-700 shadow-[0_0_50px_-12px_rgba(255,255,255,0.1)]"
          />
        </motion.div>
